...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-[#02060e] via-[#071e38] via-[#003165] via-[#004494] to-[#0356c5] ">
      <section className="flex-col items-start grid-cols-3 m-8 md:grid sm:flex sm:justify-center">
        ...
        <div className="md:text-center text-left mt-[12px]">
        ...
        <div className="text-left mt-[12px] md:text-right">
      ...
      <section className="flex-col items-start p-4 mx-auto md:flex ">
      ...
      <section  className="flex flex-col w-full p-4 text-left bg-black h-[auto] align-center gap-[3px]">
        <small>
          {" "}
